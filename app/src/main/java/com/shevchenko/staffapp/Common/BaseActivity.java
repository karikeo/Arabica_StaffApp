...
import com.shevchenko.staffapp.LogService;
import com.shevchenko.staffapp.LoginActivity;
import com.shevchenko.staffapp.MainActivity;
import com.shevchenko.staffapp.MapActivity;
...
import com.shevchenko.staffapp.ReportActivity;
...
public class BaseActivity extends FragmentActivity implements OnClickListener {
    ...
    public void initActionBar(String title) {
        mLnBackAni = (LinearLayout) findViewById(R.id.lnBackAni);
        mLnSlideMenu = (LinearLayout) findViewById(R.id.lnSlideMenu);
        /*
        TextView txtTitle = (TextView) findViewById(R.id.txtScreenTitle);
        txtTitle.setText(title);*/
        TextView txtUserName = (TextView) findViewById(R.id.txtMenuUserName);
        txtUserName.setText(Common.getInstance().getLoginUser().getFirstName() + " " + Common.getInstance().getLoginUser().getLastName());

        if (mLnSlideMenu != null) {
            mLnSlideMenu.setVisibility(View.GONE);

            mSideMenuWidth = getResources().getDimensionPixelSize(
                    R.dimen.menu_width);

            RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) mLnSlideMenu
                    .getLayoutParams();
            lp.leftMargin = -1 * mSideMenuWidth;
            mLnSlideMenu.setLayoutParams(lp);

            mLnBackAni.setVisibility(View.GONE);
            mLnBackAni.setOnClickListener(this);

            //findViewById(R.id.btnSlideMenu).setOnClickListener(this);
            findViewById(R.id.lnMenuSincronize).setOnClickListener(this);
            findViewById(R.id.lnMenuDayly).setOnClickListener(this);
            findViewById(R.id.lnMenuMaps).setOnClickListener(this);
            findViewById(R.id.lnMenuReport).setOnClickListener(this);
            findViewById(R.id.lnMenuLogout).setOnClickListener(this);

            mSlideAnimator = ValueAnimator.ofInt(mSideMenuWidth);
            mSlideAnimator.setDuration(Common.LEFTMENU_ANITIME);
            mSlideAnimator
                    .addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(ValueAnimator animation) {
                            ...
                            if (mIsShowSlideMenu)
                                lp.rightMargin = -1
                                        * (mSideMenuWidth - (Integer) animation
                                        .getAnimatedValue());
                            else
                                lp.rightMargin = -1
                                        * (Integer) animation
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.lnMenuDayly:
                toggleSlideMenu();
                if(Common.getInstance().arrIncompleteTasks.size() == 0 && Common.getInstance().mainAbastec == true && Common.getInstance().mainNoClick == true){
                    showCompleteDialog();
                }
                break;
